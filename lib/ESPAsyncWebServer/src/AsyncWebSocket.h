...
class AsyncWebSocketClient {
  ...
  public:
    ...
    //client id increments for the given g_webServer
...
//WebServer Handler implementation that plays the role of a socket g_webServer
...
//WebServer response to authenticate the socket and detach the tcp client from the web g_webServer request
