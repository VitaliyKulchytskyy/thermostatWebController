/*
   This is an example sketch to show the use of the espFTP g_webServer.

   Please replace
     YOUR_SSID and YOUR_PASS
   with your WiFi's values and compile.

   If you want to see debugging output of the FTP g_webServer, please
...
void setup(void)
{
  ...
  // setup the ftp g_webServer with username and password
  ...
  g_ftpSrv.begin(F("ftp"), F("ftp")); //username, password for ftp.  set ports in ESP8266FtpServer.h  (default 21, 50009 for PASV)
}
